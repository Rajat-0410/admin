...
class DiseaseCategorie extends Model
{
    /**
    ...
    public function disease() {
        return $this->hasMany('App\Http\Models\Disease','disease_categorie_id','id')
            ->select('id','disease_categorie_id','status','created_at','updated_at')
            ->where('is_deleted', '=' , 0);
    }
    
    public function getDiseaseCategorieDataById($id=0) {
        $arrResp    = [];
        $arrData    = [];
        $status     = 0;
        $message    = '';
    ...
    public function getDiseaseCategorieDataByUserId($user_id=0) {
        $arrResp    = [];
        $arrData    = [];
        $status     = 0;
        $message    = '';
