                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group has-feedback {!! $errors->first('short_description', ' has-error') !!}">
                                            ...
                                            {!! Form::textarea('short_description',$short_description,['class' => 'form-control','id' => 'short_description','placeholder' => 'Short Description','rows' => '5','onkeyup' => 'countNlimitChar(this)', 'onfocus' => 'countNlimitChar(this)']) !!}
