        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        {!! Form::open(['url' => 'admin/disease-category', 'id' => 'diseasecategory', 'method' => 'get', 'class' => '']) !!}
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-xs-12">
                                    <p class="help-block"><strong>Search By:</strong> Title</p>
                                </div>
                            </div>
                            
                            <div class="form-group">
                                {!! Form::submit('Search',['class' => 'btn btn-primary btn-med']) !!}&nbsp;&nbsp;
                                <a href="{!! url('admin/disease-category') !!}" class="btn btn-default btn-med">Reset</a>
                            </div>
                        {!! Form::close() !!}
                            ...
                            @if(count($all_records) > 0)
                                ...
                                @foreach($all_records as $row)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{!! url('admin/disease-category/edit', ['id' => $id]) !!}" class="btn btn-xs btn-theme" title="Edit Details" data-toggle="tooltip"><i class="fa fa-pencil"></i></a>
                                            <a href="{!! url('admin/disease-list', ['id' => $id]) !!}" class="btn btn-xs btn-theme" title="View Details" data-toggle="tooltip"><i class="fa fa-eye"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            @else 
