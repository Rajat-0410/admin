                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group has-feedback {!! $errors->first('meta_description', ' has-error') !!}">
                                            ...
                                            {!! Form::textarea('meta_description', $meta_description,['class' => 'form-control', 'rows' => 2, 'placeholder' => 'Meta Description', 'id' => 'meta_description']) !!}
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group has-feedback {!! $errors->first('meta_keywords', ' has-error') !!}">
                                            ...
                                            {!! Form::textarea('meta_keywords', $meta_keywords,['class' => 'form-control', 'rows' => 2, 'placeholder' => 'Meta Keywords', 'id' => 'meta_keywords']) !!}
