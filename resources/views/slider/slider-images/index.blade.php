...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>{{ $slider_name }}<small>Slider</small></h1>
    </section>
    <!-- Main content -->
                    ...
                    <div class="box-header with-border">
                        <div class="row">
                            ...
                            <div class="col-md-1 col-xs-4 text-right">
                                <a href="{!! url('admin/slider') !!}" class="btn btn-info btn-flat pull-right">Back</a>
                            </div>
                        </div>
                    </div><!-- /.box-header -->
                                ...
                                @foreach($all_records as $row)
                                    ...
                                    <div class="col-md-2 img-col" id="img<?php echo $id; ?>">
                                        <div class="img-container">                                            
                                            <img src="{{ asset("uploads/slider-images/thumbnail/$slider_id/$image") }}" class="img-responsive" title="{{ $image }}">
                                        </div>
...
jQuery(document).ready(function(){
    ...
    uploader.on('sending', function(file, xhr, formData){
        formData.append('slider_id', encSliderId);
    });
    ...
    uploader.on('success', function( file, resp ){
        ...
        if(status=='1'){
            ...
            var htmlCont = '<div class="col-md-2 img-col" id="img'+data.id+'">'+
                                '<div class="img-container">'+
                                    '<img src="'+SITE_URL+'/uploads/slider-images/thumbnail/'+sliderId+'/'+data.image+'" class="img-responsive" title="" id="">'+
                                '</div>'+
                                '<div class="img-actions">'+
    ...
    if(ele_length > 0){
        ...
        var slider_name = '';
        var redirectUrl = '<a href="'+SITE_URL+'/admin/action-logs/history/slider-image-gallery/0/'+encSliderId+'" class="btn btn-xs btn-theme text-aqua" data-toggle="tooltip" title="View All Logs"><i class="fa fa-history"></i></a>';
    ...
    $("#mediaCont").on("click",".remove-img", function(){
        ...
        if(ele_id != ''){
            var reqUrl = SITE_URL+'/admin/slider-images/delete';
