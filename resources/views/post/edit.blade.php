                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group has-feedback {!! $errors->first('short_content', ' has-error') !!}">
                                            ...
                                            {!! Form::textarea('short_content',$short_content,['class' => 'form-control','id' => 'short_content','placeholder' => '','rows' => '2', 'onkeyup' => 'countNlimitChar(this)']) !!}
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group has-feedback {!! $errors->first('content', ' has-error') !!}">
                                            ...
                                            {!! Form::textarea('content',$content,['class' => 'form-control', 'placeholder' => 'Content Here', 'id' => 'page_content']) !!}
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 hide" id="share_url_div">
                                                        <div class="form-group has-feedback {!! $errors->first('share_url', ' has-error') !!}">
                                                            ...
                                                            {!! Form::text('share_url',$share_url,['class' => 'form-control', 'id' => 'share_url','placeholder' => 'Share Link']) !!}
                                                    ...
                                                    <div class="col-md-12 hide">
                                                        <div class="form-group has-feedback">
                                                            ...
                                                            {!! Form::select('category_id', $arrCategories, $category_id, ['class' => 'form-control postPageCategory', 'id' => 'post_category']) !!}
                                                        </div>
                                                    </div>
